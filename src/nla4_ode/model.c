...
{
    algebraicVariables[0] = 1 / 17.0 * (voi + -51.0 * states[0]);
    algebraicVariables[1] = -1 / 12.0 * (16.0 * algebraicVariables[0] + voi + 18.0 * states[0]);
    algebraicVariables[2] = -3.0 * algebraicVariables[0] + -2.0 * states[0] + -2.0 * algebraicVariables[1];
    algebraicVariables[3] = -(4.0 * algebraicVariables[0] + states[0] + 3.0 * algebraicVariables[1] + 2.0 * algebraicVariables[2]);
