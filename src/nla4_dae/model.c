...
const size_t ALGEBRAIC_VARIABLE_COUNT = 4;
...
void objectiveFunction0(double *u, double *f, void *data)
{
    ...
    f[0] = algebraicVariables[3] + 2.0 * algebraicVariables[2] + 3.0 * algebraicVariables[1] + 4.0 * algebraicVariables[0] + states[0] - 0.0;
    f[1] = algebraicVariables[3] + algebraicVariables[2] + algebraicVariables[1] + algebraicVariables[0] + -states[0] - 0.0;
    f[2] = 4.0 * algebraicVariables[3] + -3.0 * algebraicVariables[2] + 2.0 * algebraicVariables[1] + -1.0 * algebraicVariables[0] + voi - 0.0;
    f[3] = -9.0 * algebraicVariables[3] + -2.0 * algebraicVariables[2] + 1.0 * algebraicVariables[1] + 1.0 * algebraicVariables[0] - 0.0;
}
...
void findRoot0(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    nlaSolve(objectiveFunction0, u, 4, &rfi);
...
void computeRates(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    rates[0] = algebraicVariables[3] + 3.0 * algebraicVariables[2] + -algebraicVariables[1] + 2.0 * algebraicVariables[0];
}
