...
def objective_function_0(u, f, data):
    ...
    f[0] = algebraic_variables[3]+2.0*algebraic_variables[2]+3.0*algebraic_variables[1]+4.0*algebraic_variables[0]+states[0]-0.0
    f[1] = algebraic_variables[3]+algebraic_variables[2]+algebraic_variables[1]+algebraic_variables[0]+-states[0]-0.0
    f[2] = 4.0*algebraic_variables[3]+-3.0*algebraic_variables[2]+2.0*algebraic_variables[1]+-1.0*algebraic_variables[0]+voi-0.0
    f[3] = -9.0*algebraic_variables[3]+-2.0*algebraic_variables[2]+1.0*algebraic_variables[1]+1.0*algebraic_variables[0]-0.0
...
def find_root_0(voi, states, rates, constants, computed_constants, algebraic_variables):
    ...
    u = nla_solve(objective_function_0, u, 4, [voi, states, rates, constants, computed_constants, algebraic_variables])
...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables):
    ...
    rates[0] = algebraic_variables[3]+3.0*algebraic_variables[2]+-algebraic_variables[1]+2.0*algebraic_variables[0]
