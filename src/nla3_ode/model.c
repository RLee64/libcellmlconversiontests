...
{
    algebraicVariables[0] = -1 / 12.0 * (voi + -1.1 * states[0]);
    algebraicVariables[1] = -2.0 * algebraicVariables[0] + 0.1 * states[0];
    algebraicVariables[2] = -(2.0 * algebraicVariables[1] + 3.0 * algebraicVariables[0]);
