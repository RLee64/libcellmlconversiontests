...
def objective_function_0(u, f, data):
    ...
    f[1] = algebraic_variables[6]-(algebraic_variables[2]-algebraic_variables[8])/algebraic_variables[0]+sin(100*voi*algebraic_variables[4])
    f[2] = algebraic_variables[5]-(algebraic_variables[2]-algebraic_variables[9])/algebraic_variables[1]+tan(100*voi*algebraic_variables[4])
