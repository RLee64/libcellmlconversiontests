...
void objectiveFunction0(double *u, double *f, void *data)
{
    ...
    algebraicVariables[5] = u[5];

    f[0] = algebraicVariables[5] + 2.0 * algebraicVariables[4] + 3.0 * algebraicVariables[3] + 4.0 * algebraicVariables[2] + 5.0 * algebraicVariables[1] + 6.0 * algebraicVariables[0] + states[0] - 0.0;
    f[1] = algebraicVariables[5] + algebraicVariables[4] + algebraicVariables[3] + algebraicVariables[2] + algebraicVariables[1] + algebraicVariables[0] + -states[0] - 0.0;
    f[2] = 4.0 * algebraicVariables[5] + -3.0 * algebraicVariables[4] + 2.0 * algebraicVariables[3] + -1.0 * algebraicVariables[2] + algebraicVariables[1] + -2.0 * algebraicVariables[0] + voi - 0.0;
    f[3] = algebraicVariables[5] + 4.0 * algebraicVariables[4] + -2.0 * algebraicVariables[3] + 3.0 * algebraicVariables[2] + -1.0 * algebraicVariables[1] + algebraicVariables[0] - 0.0;
    f[4] = -9.0 * algebraicVariables[5] + -2.0 * algebraicVariables[4] + 1.0 * algebraicVariables[3] + -1.0 * algebraicVariables[2] + 3.0 * algebraicVariables[1] + 2.0 * algebraicVariables[0] - 0.0;
    f[5] = 2.0 * algebraicVariables[5] + -4.0 * algebraicVariables[4] + 3.0 * algebraicVariables[3] + -6.0 * algebraicVariables[2] + 4.0 * algebraicVariables[1] + 8.0 * algebraicVariables[0] + -2.0 * voi - 0.0;
}
...
void findRoot0(double voi, double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    u[5] = algebraicVariables[5];

    nlaSolve(objectiveFunction0, u, 6, &rfi);
