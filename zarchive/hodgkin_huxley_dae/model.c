...
void initialiseArrays(double *states, double *rates, double *constants, double *computedConstants, double *algebraicVariables)
{
    ...
    algebraicVariables[1] = 3.1839;
    algebraicVariables[2] = -4.81967;
    algebraicVariables[3] = 1.035;
    algebraicVariables[4] = -10.613;
    algebraicVariables[5] = -115;
    algebraicVariables[6] = 0.223564;
    algebraicVariables[7] = 4;
    algebraicVariables[8] = 0.07;
    algebraicVariables[9] = 0.047426;
    algebraicVariables[10] = 12;
    algebraicVariables[11] = 0.058198;
    algebraicVariables[12] = 0.125;
}
