...
def compute_rates(voi, states, rates, constants, computed_constants, algebraic_variables):
    algebraicVariables[2] = states[1]/(computed_constants[2]/2.0)+constants[4]
    algebraicVariables[1] = algebraicVariables[2]+2.0*computed_constants[4]*(constants[5]-states[0])
    algebraicVariables[0] = (0.01*(constants[10]*(states[4]+constants[6]*constants[8]+states[0]*constants[7]*constants[8])*constants[11]+constants[7]*constants[8]*(states[6]+constants[9]*constants[11]))*constants[0]*(pow(2.71828182845905, constants[2]*constants[31])*constants[30]+pow(2.71828182845905, constants[2]*constants[33])*constants[32])+states[2]*constants[0]*constants[7]*constants[10]*constants[8]*constants[11]*(pow(2.71828182845905, constants[2]*constants[31])*constants[30]+pow(2.71828182845905, constants[2]*constants[33])*constants[32])+3.14159265358979*sin(10000.0*voi)*constants[7]*constants[10]*pow(constants[2], 2.0)*constants[8]*constants[11]*constants[1]+3.14159265358979*constants[7]*constants[10]*pow(constants[2], 2.0)*constants[8]*constants[11]*constants[4]*constants[1])*pow(-0.01*(-constants[10]*constants[8]*constants[11]-constants[7]*constants[8]*constants[11])*constants[0]*(pow(2.71828182845905, constants[2]*constants[31])*constants[30]+pow(2.71828182845905, constants[2]*constants[33])*constants[32])+3.14159265358979*constants[7]*constants[10]*pow(constants[2], 2.0)*constants[8]*constants[11]*constants[1], -1.0)
    rates[0] = (algebraicVariables[1]-algebraicVariables[0]-computed_constants[3]*states[0]-constants[26]*constants[27]*constants[29]*constants[1]*cos(constants[3]*3.14159265358979/180.0))/computed_constants[1]
    rates[1] = constants[5]-states[0]
    algebraicVariables[7] = states[6]/constants[11]+constants[9]
    algebraicVariables[3] = (algebraicVariables[0]-algebraicVariables[7])/constants[10]
    algebraicVariables[6] = states[4]/constants[8]+constants[6]
    algebraicVariables[4] = (algebraicVariables[0]-algebraicVariables[6])/constants[7]
    ...
    algebraicVariables[8] = states[7]/computed_constants[7]+constants[16]
    rates[3] = (algebraicVariables[6]-algebraicVariables[8]-computed_constants[8]*states[3])/computed_constants[6]
    rates[7] = states[3]-computed_constants[9]
    algebraicVariables[9] = states[8]/computed_constants[12]+constants[23]
    rates[5] = (algebraicVariables[7]-algebraicVariables[9]-computed_constants[13]*states[5])/computed_constants[11]
    rates[8] = states[5]-computed_constants[14]


def compute_variables(voi, states, rates, constants, computed_constants, algebraic_variables):
    algebraicVariables[2] = states[1]/(computed_constants[2]/2.0)+constants[4]
    algebraicVariables[5] = states[2]/(computed_constants[2]/2.0)+constants[4]
    algebraicVariables[1] = algebraicVariables[2]+2.0*computed_constants[4]*(constants[5]-states[0])
    algebraicVariables[0] = (0.01*(constants[10]*(states[4]+constants[6]*constants[8]+states[0]*constants[7]*constants[8])*constants[11]+constants[7]*constants[8]*(states[6]+constants[9]*constants[11]))*constants[0]*(pow(2.71828182845905, constants[2]*constants[31])*constants[30]+pow(2.71828182845905, constants[2]*constants[33])*constants[32])+states[2]*constants[0]*constants[7]*constants[10]*constants[8]*constants[11]*(pow(2.71828182845905, constants[2]*constants[31])*constants[30]+pow(2.71828182845905, constants[2]*constants[33])*constants[32])+3.14159265358979*sin(10000.0*voi)*constants[7]*constants[10]*pow(constants[2], 2.0)*constants[8]*constants[11]*constants[1]+3.14159265358979*constants[7]*constants[10]*pow(constants[2], 2.0)*constants[8]*constants[11]*constants[4]*constants[1])*pow(-0.01*(-constants[10]*constants[8]*constants[11]-constants[7]*constants[8]*constants[11])*constants[0]*(pow(2.71828182845905, constants[2]*constants[31])*constants[30]+pow(2.71828182845905, constants[2]*constants[33])*constants[32])+3.14159265358979*constants[7]*constants[10]*pow(constants[2], 2.0)*constants[8]*constants[11]*constants[1], -1.0)
    algebraicVariables[6] = states[4]/constants[8]+constants[6]
    algebraicVariables[4] = (algebraicVariables[0]-algebraicVariables[6])/constants[7]
